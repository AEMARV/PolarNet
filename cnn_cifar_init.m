...
net.layers{end+1} = struct('type', 'conv', ...
                           ...
                           'stride', 1, ...
                           'pad', 2) ;
net.layers{end+1} = struct('type', 'stochrelu', 'name', 'stochrelu1') ;
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'cccp1', ...
                           ...
                           'stride', 1, ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'stochrelu', 'name', 'stochrelu_cccp1') ;
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'cccp2', ...
                           ...
                           'stride', 1, ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'stochrelu', 'name', 'stochrelu_cccp2') ;
...
net.layers{end+1} = struct('type', 'stochrelu', 'name', 'stochreludrop1') ;
% Block 2
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'conv2', ...
                           ...
                           'stride', 1, ...
                           'pad', 2) ;
net.layers{end+1} = struct('type', 'stochrelu', 'name', 'stochrelu2') ;
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'cccp3', ...
                           ...
                           'stride', 1, ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'stochrelu', 'name', 'stochrelu_cccp3') ;
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'cccp4', ...
                           'weights', {{0.05*randn(1,1,192,192, 'single'), b*ones(1,192,'single')}}, ...
                           'learningRate', [.1 2], ...
                           'stride', 1, ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'stochrelu', 'name', 'stochrelu_cccp4') ;
...
net.layers{end+1} = struct('type', 'stochrelu', 'name', 'stochreludrop2') ;
% Block 3
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'conv3', ...
                           ...
                           'stride', 1, ...
                           'pad', 1) ;
net.layers{end+1} = struct('type', 'stochrelu', 'name', 'stochrelu3') ;
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'cccp5', ...
                           'weights', {{0.05*randn(1,1,192,192,'single'), b*ones(1,192,'single')}}, ...
                           'learningRate', [.1 2], ...
                           'stride', 1, ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'stochrelu', 'name', 'stochrelu_cccp5') ;
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'cccp6', ...
                           ...
                           'stride', 1, ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'stochrelu', 'name', 'stochrelu_cccp6') ;
